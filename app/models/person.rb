class Person < ApplicationRecord
  ...
  uniqueness: { case_sensitive: false }, length: { minimum: 5, maximum: 128 }, presence: true
  validate :available_date_must_be_in_the_future
  validates :user_types, presence: true, numericality: { only_integer: true }
  ...
  def available_date_must_be_in_the_future
    errors.add(:available_on, "can't be in the past") if
